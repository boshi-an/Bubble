		...
		<div  class="comment-item">
			...
			<div class="comment-body">
				<div class="comment-head">
					<h5><?php $comments->gravatar(80, ''); ?> <?php _e(' · '); ?> <?php $comments->author(); ?> · <small><?php $comments->date('Y-m-d H:i'); ?></small> <?php
					if ($comments->authorId) {
						if ($comments->authorId == $comments->ownerId) {
							_e(' · <span class="badge badge-pill badge-primary"><i class="ni ni-circle-08" aria-hidden="true"></i> 作者</span>');
						}
					}
					?></h5>
				</div>
				...
				<div style="float: right;">
					<?php $comments->reply('<i class="ni ni-chat-round" aria-hidden="true"></i> 回复'); ?>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="container" id="comments">
		<div class="content">
			...
			<?php if ($comments->have()): ?>
				...
				<div class="row align-items-center justify-content-center"><nav class="comment-nav"><?php $comments->pageNav('<i class="ni ni-bold-left" aria-hidden="true"></i>', '<i class="ni ni-bold-right" aria-hidden="true"></i>', 2, '...', array('wrapTag' => 'ul', 'wrapClass' => 'pagination', 'currentClass' => 'active', 'prevClass' => '', 'nextClass' => '')); ?></nav></div>
			<?php endif; ?>
							...
							<div class="row">
									...
									<div class="form-group">
										<div class="input-group mb-4">
											<div class="input-group-prepend">
												<span class="input-group-text"><i class="ni ni-circle-08" aria-hidden="true"></i></span>
											</div>
								...
								<div class="col-md-4">
									<div class="form-group">
										<div class="input-group mb-4">
											<div class="input-group-prepend">
												<span class="input-group-text"><i class="ni ni-world" aria-hidden="true"></i></span>
											</div>
